              ...
              ${
                ...
                <div class="customer-info mb-4 p-3 bg-light rounded">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control rounded-0 border-top-0 border-start-0 border-end-0 border-dark bg-light px-0" id="customer-name" placeholder="Your Name" value="${App.firebase.user.displayName}" required>
                  </div>
                  <div class="mb-3">
                    <label for="customer-address" class="form-label small text-muted">Address</label>
                    <input class="form-control rounded-0 border-top-0 border-start-0 border-end-0 border-dark bg-light px-0" id="customer-address" rows="2" placeholder="Your Address" value="${App.firebase.user.address}" required>
                  </div>
                  <div class="mb-3">
                    <label for="customer-phone" class="form-label small text-muted">Phone Number</label>
                    <input type="number" class="form-control rounded-0 border-top-0 border-start-0 border-end-0 border-dark bg-light px-0" id="customer-phone" placeholder="Your Phone Number" value="${App.firebase.user.phoneNumber}" required>
                  </div>
                </div>
