 ...
 */
export function ImageUploader(inputId, imagePreviewId, progressId, uploadButtonId, clearButtonId) {
  return /*html*/`
 ...
 */
export function setupImageUploader(inputId, imagePreviewId, progressId, uploadButtonId, clearButtonId, uploadPreset, onUploadComplete) {
  ...
  fileInput.addEventListener('change', async (e) => {
    ...
    try {
      ...
      // Upload image
      const uploadedUrl = await uploadToCloudinary(file, uploadPreset, updateProgress);
